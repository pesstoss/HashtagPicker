const hashtags = {
    ...
    spec1: "#snap_allblack #snap_allwhite #snap_abstract #snap_surreal #snap_communityarts #snap_artgallery #pictasart #snap_textures #snap_minimal #snap_potd #snap_longexposure #snap_depthoffield #snap_nightshots #podium_night",
    spec2: "#snap_reflection #snap_symmetry #snap_silhouette #snap_cuteness #snap_moody #pictasmoody #snap_mobile #snap_macro #podium_macro #rebel_macro #snap_edit snap_filmfoto #snap_colours #snap_colorsplash #snap_numbers",
...
modifyButton.addEventListener('click', () => {
    ...
    copyButton.addEventListener('click', () => {
        ...
        copyButton.removeEventListener('click', arguments.callee);
