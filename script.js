document.addEventListener('DOMContentLoaded', function() {
    const hashtags = {
        ...
        spec2: ["#snap_reflection", "#snap_symmetry", "#snap_silhouette", "#snap_cuteness", "#snap_moody", "#pictasmoody", "#snap_mobile", "#snap_macro", "#podium_macro", "#rebel_macro", "#snap_edit", "#snap_filmfoto", "#snap_colours", "#snap_colorsplash", "#snap_ai", "#snap_numbers", "#podium_wildlife"],
    ...
    themeSelect.addEventListener('change', () => {
        ...
        if (hashtags[selectedTheme]) {
            hashtags[selectedTheme].forEach(hashtag => {
